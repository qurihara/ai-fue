...
\journalhead{論文タイトル（登壇発表用テンプレート）} %%%%%% ←←　著者において必ず記入すること

\begin{document}

% デモ・ポスター・ロングティザー用のテンプレートではありません
\title{WISS論文タイトル\textcolor{red}{（登壇発表用テンプレート）}}
...
この\LaTeXe{}用スタイルクラスは，WISS 2026 における
...
らない．また，ページ数は必ず規定のページ数でなければならない（詳細はWISS2026サイトから査読方針のページを参照）．
% （詳細は査読方針 \url{https://www.wiss.org/WISS2026/review-policy.html}を参照）．
